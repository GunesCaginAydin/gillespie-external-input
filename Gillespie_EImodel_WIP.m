function [spike_times,spike_ids,network_state] = Gillespie_EImodel_WIP(W,response_fn,beta,alpha,I,t_min,t_max,init_state)
...
while ((curr_time + dt) < t_max)
    ...
    curdif = Icurr - Ipast; % initial
    currents = currents + curdif;
    if(new_state(1) == 1)
