function [spike_times,spike_ids,network_state,I_recons] = TauLeaping_EImodel(W,response_fn,beta,alpha,I,t_min,t_max,init_state)

% Simulates a 2-state Wilson-Cowan model with the Tau Leaping algorithm and
...
% Main loop: update according to Tau Leaping algorithm, with rates
